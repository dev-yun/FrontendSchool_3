...
// 모든 CEO를 replace => ("paullab CEO leehojun hello CEO").replaceAll("CEO", "CTO");
...
/CEO/.test("paullab CEO leehojun hello CEO");
// true
...
"CAZGBEUDKKCAEEEEEBEEEDEEEEEEEEE"("CAZGBEUDKKA")
  .match(/[CBD]/g)("CEEEEEBEEEDEEEEEEEEE")
  .match(/[CBD]/g);
